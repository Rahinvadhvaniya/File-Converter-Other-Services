      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Rotate your PDF pages by 90, 180, or 270 degrees
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
          ...
          >
            {converting ? "Rotating..." : `Rotate PDF by ${rotation}°`}
          </button>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to rotate PDF:</h2>
          <ol className="space-y-2 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Choose the rotation angle (90°, 180°, or 270°)</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">3.</span>
              <span>Click the &quot;Rotate PDF&quot; button</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">4.</span>
              <span>Download your rotated PDF document</span>
            </li>
          </ol>
        </div>
      </div>
