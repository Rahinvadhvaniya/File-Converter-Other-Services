      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Convert your JPG images to PDF documents in seconds
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to convert JPG to PDF:</h2>
          <ol className="space-y-2 text-gray-700">
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">1.</span>
              <span>Select your JPG image using the file picker above</span>
            </li>
            <li className="flex items-start gap-3">
