    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
          ...
          >
            {converting ? "Compressing..." : "Compress PDF"}
          </button>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to compress PDF:</h2>
          <ol className="space-y-2 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Wait a few seconds for the compression to complete</span>
            </li>
            <li className="flex items-start gap-3">
