    ...
    try {
      ...
      const convertResponse = await fetch("/api/convert", {
        ...
        body: JSON.stringify({
          ...
          options: {
            pageRanges: [{ start: startPage - 1, end: endPage - 1 }],
          },
        }),
      });
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
          ...
          >
            {converting ? "Splitting..." : "Split PDF"}
          </button>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to split PDF:</h2>
          <ol className="space-y-2 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Enter the start and end page numbers to extract</span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Download your extracted PDF pages</span>
            </li>
          </ol>
        </div>
      </div>
