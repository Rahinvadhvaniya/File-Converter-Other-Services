...
export default function UnlockPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      alert("Unlock failed. Please try again or check the password.");
    } finally {
      setConverting(false);
    }
  };
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to unlock PDF:</h2>
          <ol className="space-y-2 text-gray-700">
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">1.</span>
              <span>Select your password-protected PDF file</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">2.</span>
              <span>Enter the password if your PDF requires one</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">3.</span>
              <span>Click the &quot;Unlock PDF&quot; button</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">4.</span>
              <span>Download your unlocked PDF document</span>
            </li>
          </ol>
        </div>
      </div>
