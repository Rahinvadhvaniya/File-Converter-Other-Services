...
export default function ExcelToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      alert("Excel converted to PDF successfully!");
    } catch (error) {
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Excel to PDF Converter</h1>
          <p className="text-gray-600">
            Convert your Excel spreadsheets to PDF files in seconds
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to convert Excel to PDF:</h2>
          <ol className="space-y-2 text-gray-700">
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">1.</span>
              <span>Select your Excel file using the file picker above</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-bold text-red-600">2.</span>
              <span>Click the &quot;Convert to PDF&quot; button</span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Download your converted PDF document</span>
            </li>
          </ol>
        </div>
      </div>
