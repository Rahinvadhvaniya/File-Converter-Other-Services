      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Convert your PDF files to Excel spreadsheets in seconds
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          <h2 className="font-bold text-xl mb-4">How to convert PDF to Excel:</h2>
          <ol className="space-y-2 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Click the &quot;Convert to Excel&quot; button</span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Download your converted Excel spreadsheet</span>
            </li>
          </ol>
        </div>
      </div>
